...
if($_POST){
    ...
    if ($newpassword==$cpassword){
        ...
        if($result->num_rows==1){
            ...
            //TODO
            $database->query("insert into patient(pemail,pname,ppassword, paddress, pnic,pdob,ptel) values('$email','$name','$newpassword','$address','$nic','$dob','$telp');");
        ...
        $error='<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Kesalahan Konformasi Kata Sandi! Rekonformasi Kata Sandi</label>';
    }
        ...
        <table border="0" style="width: 69%;">
            <tr>
                <td colspan="2">
                    ...
                    <p class="sub-text">Tidak apa-apa, Sekarang Buat Akun Pengguna.</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <input type="text" name="tele" class="input-text" placeholder="Nomer Telpon" >
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
            ...
            <tr>
                ...
                <td>
                    <input type="submit" value="Mendaftar" class="login-btn btn-primary btn">
                </td>
