                            ...
                            <center>
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        ...
                                        <td class="label-td" colspan="2">
                                            <label for="cpassword" class="form-label">Konfir kata sandi: </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="cpassword" class="input-text" placeholder="Konfir kata sandi" required><br>
                                        </td>
                                    </tr>
