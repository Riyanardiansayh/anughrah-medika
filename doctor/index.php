                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid  where schedule.scheduledate>='$today' and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc"; 
                                                ...
                                                for ( $x=0; $x<$result->num_rows;$x++){
                                                    ...
                                                    $nop=$row["nop"];
                                                    echo '<tr>
                                                        <td style="padding:20px;">  <div style="display:flex;justify-content: center;"> &nbsp;'.
                                                        substr($title,0,30)
                                                        .'</div></td>
                                                        <td style="padding:20px;font-size:13px;">  <div style="display:flex;justify-content: center;">
                                                        '.substr($scheduledate,0,10).' </div>
                                                        </td>
                                                        <td style="text-align:center;">  <div style="display:flex;justify-content: center;">
                                                            '.substr($scheduletime,0,5).' </div>
                                                        </td>
