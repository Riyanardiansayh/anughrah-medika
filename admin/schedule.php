    ...
    <tr class="menu-row">
        <td class="menu-btn menu-icon-appoinment">
            <a href="appointment.php" class="non-style-link-menu">
                <div>
                    <p class="menu-text">Janji temu</p>
            </a></div>
        </td>
    </tr>
    <tr class="menu-row">
        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <td colspan="4">
                    <div style="display: flex;margin-top: 40px;">
                        <div class="heading-main12"
                            style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49);margin-top: 5px;">Jadwalkan
                            Sesi</div>
                        <a href="?action=add-session&id=none&error=0" class="non-style-link"><button
                                class="login-btn btn-primary btn button-icon"
                                style="margin-left:25px;background-image: url('../img/icons/add.svg');">Tambahkan Sesi
                                </font></button>
                        </a>
                    </div>
                </td>
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;width: 100%;">
                    ...
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Semua Sesi
                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    <select name="docid" id="" class="box filter-container-items"
                                        ...
                                        <option value="" disabled selected hidden>Pilih Nama Dokter dari daftar</option>
                                        <br />
                            ...
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <br><br><br><br>
                                        ...
                                        <td style="text-align:center;">
                                            ' . substr($scheduledate, 0, 10) . ' ( ' . substr($scheduletime, 0, 50) . ' )
                                        </td>
                                        <td style="text-align:center;">
                                            ' . $nop . '
                                        </td>
        ...
        if ($action == 'add-session') {
            ...
            <div id="popup1" class="overlay">
                ...
                . '</td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="title" class="input-text" placeholder="Hari Jadwal" required><br>
                                </td>
                            </tr>
                            <tr>
            ...
            echo '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="time" class="input-text" placeholder="Time" required><br>
                                </td>
                            </tr>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nic" class="form-label">Tanggal yang Dijadwalkan: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Tele" class="form-label">Waktu yang Dijadwalkan: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
