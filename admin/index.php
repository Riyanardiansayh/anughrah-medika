    ...
    <div class="container w-100">
        ...
        <div class="dash-body" style="margin-top: 15px">
            <div class="table-body">
                <table border="0" width="100%" class="t-body" style=" border-spacing: 0;margin:0;padding:0;">
                        ...
                        <td colspan="2" class="nav-bar">
                            ...
                            <form action="doctors.php" method="post" class="header-search">
                                ...
                                <input type="search" name="search" class="input-text header-searchbar"
                                    placeholder="Cari nama Pasien atau Email" list="doctors">&nbsp;&nbsp;
                                ...
                                <input type="Submit" value="Cari " class="login-btn btn-primary-soft btn"
                        ...
                        <td colspan="4">
                            <table width="100%" border="0" class="dashbord-tables">
                                <tr>
                                    <td>
                                        <p
                                            ...
                                            Janji Mendatang sampai Berikutnya <?php
                                        ...
                                        <p
                                            ...
                                            Berikut akses cepat ke Janji Mendatang hingga 7 hari<br>
                                            Detail lebih lanjut tersedia di bagian @Janji temu.
                                        </p>
                                        ...
                                        <center>
                                            <div class="abc scroll" style="height: 200px;">
                                                <table width="85%" class="sub-table scrolldown" border="0">
                                                    ...
                                                    INNER JOIN patient ON patient.pid = appointment.pname
                                ...
                                <tr>
                                    <td>
                                        <center>
                                            <a href="appointment.php" class="non-style-link"><button
                                                    class="btn-primary btn" style="width:85%">Tampilkan semua Janji
                                                    Temu</button></a>
                                        </center>
                                    </td>
                                    <td>
                                        <center>
                                            <a href="schedule.php" class="non-style-link"><button
                                                    class="btn-primary btn" style="width:85%">Tampilkan semua
                                                    Sesi</button></a>
                                        </center>
                                    </td>
                                </tr>
