        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;width: 100%;">
                    ...
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Semua Janji
            ...
            <tr>
                <td colspan="4">
                    <button onclick="printSection()" class="print-btn"
                        style="margin-left: 60px; margin-bottom: 20px;">🖨 Print</button>
                    <a href="export.php"><button class="excel-btn" style="margin-left: 30px; margin-bottom: 20px;">🖨
                            excel</button></a>
                    <center>

                        <div class="abc scroll" id="printArea">
    ...
    if ($_GET) {
        ...
        if ($action == 'add-session') {
            ...
            echo '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="time" name="time" class="input-text" placeholder="Waktu" diperlukan><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <input type="submit" value="Place this Session" class="login-btn btn-primary btn" name="pengiriman jadwal">
                                </td>
