...
if ($userrow && $userrow->num_rows > 0) {
    ...
    die("No user found or query failed: " . $database->error);
}
                ...
                <td>
                    <form action="schedule.php" method="post" class="header-search">
                        ...
                        <input type="search" name="search" class="input-text header-searchbar"
                            placeholder="Cari Nama Dokter atau Email atau Tanggal (YYYY-MM-DD)" list="doctors">&nbsp;&nbsp;
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;">
                                                            Judul Sesi: '.$title.'<br>
                                                            Tanggal Sesi Dijadwalkan: '.$scheduledate.'<br>
                                                           Sesi Dimulai : '.$scheduletime.'<br>
