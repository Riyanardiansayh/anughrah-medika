            ...
            <table class="menu-container" border="0">
                    ...
                    <td style="padding:10px" colspan="2">
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <p class="profile-title" style="font-size: 18px;"><?php echo substr($username,0,50)  ?></p>
                                <p class="profile-subtitle"  style="font-size: 14px; padding-top:10px;"><?php echo substr($useremail,0,50)  ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session">
                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Sesi Terjadwal</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">Pemesanan Saya</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">lihat Detailnya.</p><br><br>
                                </td>
                            </tr>
